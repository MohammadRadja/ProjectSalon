<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div id="dashboard-grid" style="display: grid; grid-template-columns: 1fr 4fr;">
            {{-- Sidebar --}}
            <div id="sidebar" class="hidden sm:block bg-white border-r min-h-screen">
                        ...
                        <div class="overflow-y-auto overflow-x-hidden flex-grow">
                            ...
                            ">
                                ...
                                ">
                                                ...
                                                <span class="ml-2 text-sm tracking-wide truncate">Manage
                                                    Locations</span>
            ...
            <div class="">
                @if (session('errormsg'))
                    <div
                        class="mb-4 font-medium text-sm text-red-600 max-sm:text-center max-sm:flex max-sm:justify-center">
                        {{ session('errormsg') }}
                    </div>
                @endif
                ...
                @if (session('success'))
                    <div
                        class="mb-4 font-medium text-sm text-green-600 max-sm:text-center max-sm:flex max-sm:justify-center">
                        {{ session('success') }}
                    </div>
                @endif
                <div>
