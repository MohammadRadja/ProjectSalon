<div>
    <div>
        ...
        <div class="flex justify-between mx-7 max-sm:flex-col max-sm:items-start max-sm:gap-3 max-sm:mx-4">
            <h2 class="text-2xl font-bold max-sm:text-lg">Deals</h2>
        ...
        <div class="overflow-auto rounded-lg border border-gray-200 shadow-md m-5">
            ...
            {{-- Table Section --}}
            <table
                class="w-full border-collapse bg-white text-left text-sm text-gray-500 overflow-x-scroll min-w-screen max-sm:text-sm max-sm:text-center">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="pl-6 py-4 font-medium text-gray-900 max-sm:hidden">Id</th>
                        <th scope="col" class="px-4 py-4 font-medium text-gray-900">Name</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900 max-sm:hidden">Description</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Discount</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900 max-sm:hidden">Date Start</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900 max-sm:hidden">Date End</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900 max-sm:hidden">Is Hidden</th>
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    @foreach ($deals as $deal)
                        <tr class="hover:bg-gray-50">
                            <td class="pl-6 py-4  max-w-0 max-sm:hidden">{{ $deal->id }}</td>

                            <td class="px-6 py-4 max-w-xs font-medium text-gray-700">{{ $deal->name }}
                            </td>

                            <td class="px-6 py-4 max-w-xs max-sm:hidden">{{ $deal->description }}</td>
                            <td class="px-6 py-4 max-w-0 max-sm:px-2 text-center">
                                <div class="font-medium text-gray-700">{{ $deal->discount }} %</div>
                            </td>
                            <td class="px-6 py-4 max-w-0 max-sm:hidden">
                            ...
                            <td class="px-6 py-4 max-sm:px-2 text-center">
                                <div
                                    class="mt-5 flex flex-col gap-1 items-center max-sm:flex-row max-sm:gap-2 max-sm:mt-0">
