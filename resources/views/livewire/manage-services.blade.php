<div>
    ...
    <div class="flex justify-between mx-7 max-sm:flex-col max-sm:items-start max-sm:gap-3 max-sm:mx-4">
        ...
        <x-button wire:click="confirmServiceAdd"
    ...
    <div class="flex flex-col gap-4 m-5 max-sm:m-3">
        ...
        {{-- Search Bar --}}
        <div class="self-end w-1/3 max-sm:w-full max-sm:self-auto">
        ...
        <table class="w-full border-collapse bg-white text-left text-sm text-gray-500 overflow-x-scroll min-w-screen">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900 max-sm:hidden">Photo</th>
            ...
            <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                @foreach ($services as $service)
                    <tr class="hover:bg-gray-50">
                        <td class="pl-6 py-4  max-w-0 max-sm:hidden">{{ $service->id }}</td>
                        ...
                        <td class="px-6 py-4 max-w-0 max-sm:hidden">{{ $service->description }}</td>
